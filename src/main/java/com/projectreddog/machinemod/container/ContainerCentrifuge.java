...
public class ContainerCentrifuge extends Container {
	...
	public ContainerCentrifuge(PlayerInventory inventoryPlayer, TileEntityCentrifuge centrifuge) {
	...
	public void detectAndSendChanges() {
		...
		this.lastFuelStorage = this.centrifuge.getField(0);

	}

	@OnlyIn(Dist.CLIENT)
	public void updateProgressBar(int id, int data) {
		this.centrifuge.setField(id, data);
	}
}

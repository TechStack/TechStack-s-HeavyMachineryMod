...
public class GuiExcavator extends ContainerScreen {

	public GuiExcavator(PlayerInventory inventoryPlayer, EntityExcavator excavator) {
		// the container is instanciated and passed to the superclass for
		// handling

		super(new ContainerExcavator(inventoryPlayer, excavator));
	}

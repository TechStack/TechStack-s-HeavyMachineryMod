...
public class GuiCanner extends ContainerScreen {

	private TileEntityFuelPump canner;

	public GuiCanner(PlayerInventory inventoryPlayer, TileEntityFuelPump canner) {
		// the container is instanciated and passed to the superclass for
		// handling

		super(new ContainerCanner(inventoryPlayer, canner));
		this.canner = canner;
	}

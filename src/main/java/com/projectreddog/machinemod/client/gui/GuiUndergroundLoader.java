...
public class GuiUndergroundLoader extends GuiContainer {

	public GuiUndergroundLoader(InventoryPlayer inventoryPlayer, EntityUnderGroundLoader loader) {
		// the container is instanciated and passed to the superclass for
		// handling

		super(new ContainerUndergroundLoader(inventoryPlayer, loader));
	}

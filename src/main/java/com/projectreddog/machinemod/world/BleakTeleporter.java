...
public class BleakTeleporter extends Teleporter {
	...
	public BleakTeleporter(WorldServer world, double x, double y, double z) {
		super(world);
	...
	public static void teleportToDimension(EntityPlayer player, int dimension, double x, double y, double z) {
		...
		worldServer.getMinecraftServer().getPlayerList().transferPlayerToDimension(entityPlayerMP, dimension, new BleakTeleporter(worldServer, x, y, z));

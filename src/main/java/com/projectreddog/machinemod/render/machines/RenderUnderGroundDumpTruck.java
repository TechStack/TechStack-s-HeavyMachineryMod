...
public class RenderUnderGroundDumpTruck extends Render {

	protected ModelBase modelUnderGroundDumpTruck;

	private RenderItem itemRenderer;

	public RenderUnderGroundDumpTruck(RenderManager renderManager) {

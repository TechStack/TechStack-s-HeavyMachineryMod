...
import com.projectreddog.machinemod.model.ModelUnderGroundDumpTruck;
...
public class RenderUnderGroundDumpTruck extends EntityRenderer {

	protected EntityModel modelUnderGroundDumpTruck;

	private ItemRenderer itemRenderer;

	public RenderUnderGroundDumpTruck(EntityRendererManager renderManager) {

		super(renderManager);

		// LogHelper.info("in RenderDumpTruck constructor");
		shadowSize = 1F;
		this.modelUnderGroundDumpTruck = new ModelUnderGroundDumpTruck();
	...
	public void doRender(Entity entity, double x, double y, double z, float yaw, float pitch) {
		...
		EntityUnderGroundDumpTruck eDT = ((EntityUnderGroundDumpTruck) entity);

...
import com.projectreddog.machinemod.model.ModelTank;
import com.projectreddog.machinemod.reference.Reference;

public class RenderTank extends Render {

	protected ModelBase modelTank;
	...
	public void doRender(Entity entity, double x, double y, double z, float yaw, float pitch) {
		...
		this.modelTank.render(entity, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation("machinemod", Reference.MODEL_TANK_TEXTURE_LOCATION);
	}

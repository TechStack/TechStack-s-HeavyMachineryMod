...
public class BlockMachineModConveyorT2 extends BlockContainer {
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	public static final PropertyBool POWERED = PropertyBool.create("powered");

	protected BlockMachineModConveyorT2(Material material) {
		super(material);
		...
		// 1.8
		this.setUnlocalizedName(Reference.MOD_ID.toLowerCase() + ":" + Reference.MODBLOCK_MACHINE_CONVEYOR_T2);
		this.setRegistryName(Reference.MODBLOCK_MACHINE_CONVEYOR_T2);
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos) {
		...
		if (te instanceof TileEntityConveyorT2) {
			powered = ((TileEntityConveyorT2) te).getPowered();
		}
		return state.withProperty(POWERED, powered);
	}

	public BlockMachineModConveyorT2() {
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		...
		return new TileEntityConveyorT2();
	}

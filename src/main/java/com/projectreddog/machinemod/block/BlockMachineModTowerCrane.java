...
public class BlockMachineModTowerCrane extends BlockContainer {
	...
	public static final AxisAlignedBB EXTRA_TALL_BLOCK_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 30.0D, 1.0D);
	...
	protected BlockMachineModTowerCrane(Material material) {
		...
		this.setRegistryName(Reference.MODBLOCK_MACHINE_TOWER_CRANE);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		...
		return new TileEntityTowerCrane();
	}

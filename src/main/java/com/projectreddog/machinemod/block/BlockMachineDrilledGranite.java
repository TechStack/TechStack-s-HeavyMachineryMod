...
public class BlockMachineDrilledGranite extends BlockMachineModManyTexture {
	public static final PropertyDirection FACING = PropertyDirection.create("facing");

	public BlockMachineDrilledGranite() {
		super();
		// 1.8
		// REMOVED 1.14
		// this.setUnlocalizedName(Reference.MODBLOCK_MACHINE_DRILLED_GRANITE);
		this.setRegistryName(Reference.MODBLOCK_MACHINE_DRILLED_GRANITE);

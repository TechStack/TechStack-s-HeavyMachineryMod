...
public class EntityMachineModRideable extends Entity implements IInventory {
	...
	public void updateServer() {
		...
		ModNetwork.sendPacketToAllAround((new MachineModMessageEntityToClient(this.getEntityId(), this.posX, this.posY, this.posZ, this.yaw, this.Attribute1, this.currentFuelLevel)), new TargetPoint(worldObj.provider.getDimensionId(), posX, posY, posZ, 224)); // sendInterval = 0;

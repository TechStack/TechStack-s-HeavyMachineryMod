package com.projectreddog.machinemod.entity.projectile;
...
public class EntityTankShell extends Entity implements IProjectile {
	private int ticksInGround;
	public Entity shootingEntity;
	private int ticksInAir;

	public EntityTankShell(World worldIn) {
		super(worldIn);
		// TODO Auto-generated constructor stub
	}

	public EntityTankShell(World worldIn, EntityLivingBase p_i1756_2_, float p_i1756_3_) {
		super(worldIn);
		...
		for (i = 0; i < list.size(); ++i) {
			...
			if (movingobjectposition != null) {
				if (movingobjectposition.entityHit != null) {
					...
					int k = MathHelper.ceiling_double_int((double) f2 * 2f);

					DamageSource damagesource;

					damagesource = new DamageSource(Reference.MOD_ID + ":tankSHell");

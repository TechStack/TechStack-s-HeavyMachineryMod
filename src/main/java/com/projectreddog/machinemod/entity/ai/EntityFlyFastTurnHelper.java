...
public class EntityFlyFastTurnHelper extends EntityMoveHelper {
	public EntityFlyFastTurnHelper(EntityLiving p_i47418_1_) {
		super(p_i47418_1_);
	}
	...
	public void onUpdateMoveHelper() {
		if (this.action == EntityMoveHelper.Action.MOVE_TO) {
			...
			this.entity.rotationYaw = this.limitAngle(this.entity.rotationYaw, f, 35.0F);
			float f1;
			...
			this.entity.rotationPitch = this.limitAngle(this.entity.rotationPitch, f2, 35.0F);

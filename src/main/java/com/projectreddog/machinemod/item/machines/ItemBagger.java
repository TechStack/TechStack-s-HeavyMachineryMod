...
public class ItemBagger extends ItemMachineModMachine {
	...
	// public EnumActionResult onItemUse(ItemStack stack, PlayerEntity playerIn, World worldIn, BlockPos pos, EnumHand hand, Direction facing, float hitX, float hitY, float hitZ)

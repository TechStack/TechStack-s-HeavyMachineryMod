...
import com.projectreddog.machinemod.item.machines.ItemTank;
...
public class ModItems {
	...
	public static final ItemMachineMod tank = new ItemTank();
	...
	public static void initItemRender() {
		...
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(tank, 0, new ModelResourceLocation(Reference.MOD_ID + ":" + "tank", "inventory"));

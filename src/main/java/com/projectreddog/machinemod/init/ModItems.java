...
public class ModItems {
	...
	public static void initItemRender() {
		...
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(steeltoeboots, 0, new ModelResourceLocation(Reference.MOD_ID + ":" + "steeltoeboots", "inventory"));
		...
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(blueprintholoscanner, 0, new ModelResourceLocation(Reference.MOD_ID + ":" + "blueprintholoscanner", "inventory"));

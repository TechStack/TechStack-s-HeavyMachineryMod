...
public class ModelDistiller extends EntityModel {
	// fields
	...
	public ModelDistiller() {
		...
		try {
			objModel = (OBJModel) OBJLoader.INSTANCE.loadModel(new ResourceLocation(Reference.MOD_ID.toLowerCase(), "models/distiller.obj"));

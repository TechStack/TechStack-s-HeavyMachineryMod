...
public class ModelCentrifuge extends EntityModel {
	// fields
	...
	public ModelCentrifuge() {
		...
		try {
			objModel = (OBJModel) OBJLoader.INSTANCE.loadModel(new ResourceLocation(Reference.MOD_ID.toLowerCase(), "models/centrifuge.obj"));

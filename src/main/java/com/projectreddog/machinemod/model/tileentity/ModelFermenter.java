...
public class ModelFermenter extends EntityModel {
	// fields
	...
	public ModelFermenter() {
		...
		try {
			objModel = (OBJModel) OBJLoader.INSTANCE.loadModel(new ResourceLocation(Reference.MOD_ID.toLowerCase(), "models/fermenter.obj"));
	...
	public ResourceLocation getTexture() {
		...
		return new ResourceLocation("machinemod", Reference.MODEL_FERMENTER_TEXTURE_LOCATION);
	}

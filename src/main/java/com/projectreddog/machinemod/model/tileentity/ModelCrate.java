...
public class ModelCrate extends EntityModel {
	// fields
	...
	public ModelCrate() {
		...
		try {
			objModel = (OBJModel) OBJLoader.INSTANCE.loadModel(new ResourceLocation(Reference.MOD_ID.toLowerCase(), "models/crate.obj"));

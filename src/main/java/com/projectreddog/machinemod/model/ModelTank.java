...
public class ModelTank extends ModelTransportable {
	// fields
	...
	public ModelTank() {
		...
		myModel = AdvancedModelLoader.loadModel(new ResourceLocation(Reference.MOD_ID.toLowerCase(), "models/tank.obj"));

...
public class ModelTankShell extends ModelTransportable {
	// fields
	...
	public ModelTankShell() {
		...
		myModel = AdvancedModelLoader.loadModel(new ResourceLocation(Reference.MOD_ID.toLowerCase(), "models/tankshell.obj"));
